...
public class UserNurse implements UserDetails, Serializable {
    ...
    @JoinColumn(name = "id_usernurse_status", referencedColumnName = "id")
    @ManyToOne
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UserNurse)) {
            return false;
        }
        UserNurse other = (UserNurse) object;
