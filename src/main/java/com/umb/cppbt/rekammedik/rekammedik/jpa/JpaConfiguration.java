package com.umb.cppbt.rekammedik.rekammedik.jpa;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.umb.cppbt.rekammedik.rekammedik.repository",
...
public class JpaConfiguration
{
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.umb.cppbt.rekammedik.rekammedik.domain" });
