...
public class UserAdmin implements UserDetails, Serializable {
    ...
    @JoinColumn(name = "id_useradmin_status", referencedColumnName = "id")
    @ManyToOne
	...
	public void setAdminCode(String userCode) {
	...
	public String toString() {
		return "AppUser [id=" + id + ", address=" + address + ", dateBirth="
				...
				+ ", adminCode=" + adminCode + ", gender=" + gender
