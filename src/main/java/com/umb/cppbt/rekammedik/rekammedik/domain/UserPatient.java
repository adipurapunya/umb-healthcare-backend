...
public class UserPatient implements UserDetails, Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UserPatient)) {
            return false;
        }
        UserPatient other = (UserPatient) object;
	...
	public String toString() {
		return "AppUser [id=" + id + ", address=" + address + ", dateBirth="
				...
				+ ", patientCode=" + patientCode + ", gender=" + gender
